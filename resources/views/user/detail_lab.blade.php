        ...
        <div class="p-8 grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div class="md:col-span-1">
                <div class="bg-blue-50 p-6 rounded-xl border border-blue-100 sticky top-24 shadow-sm">
                    ...
                    @auth
                        <a href="/" class="block w-full text-center bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 rounded-lg shadow-lg shadow-blue-500/30 transition transform hover:-translate-y-0.5">
                            Pinjam Lab Ini
                        </a>
                    @else
